    ...
    >
        ...
        <slot name="iconRight">
            <div
                ...
                class="flex w-0 shrink-0 translate-x-full items-center justify-center pl-0 opacity-0 transition-all duration-200 group-hover:w-6 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100"
            >
                <Icon :name="icon" class="size-5" />
            </div>
        </slot>
